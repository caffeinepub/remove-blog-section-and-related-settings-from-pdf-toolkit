                ...
                <CardContent className="space-y-4">
                  <RadioGroup value={splitMode} onValueChange={(value) => setSplitMode(value as SplitMode)}>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="range" id="range" disabled={isSplitting} />
                      <Label htmlFor="range">{t('splitPdf.options.range')}</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="per-page" id="per-page" disabled={isSplitting} />
                      <Label htmlFor="per-page">{t('splitPdf.options.perPage')}</Label>
                    </div>
                  </RadioGroup>
                  ...
                  {splitMode === 'range' && (
                    <div className="grid grid-cols-2 gap-4 pt-2">
                      <div className="space-y-2">
                        <Label htmlFor="startPage">{t('splitPdf.options.startPage')}</Label>
                        <Input
                          id="startPage"
                          type="number"
                          min="1"
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="endPage">{t('splitPdf.options.endPage')}</Label>
                        <Input
                          id="endPage"
                          type="number"
                          min="1"
